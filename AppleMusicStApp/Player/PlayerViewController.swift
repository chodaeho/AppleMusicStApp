...
//        DispatchQueue.main : main 스레드 사용
    ...
    @IBAction func seek(_ sender: UISlider) {
        ...
        let secondes = position * currentItem.duration.seconds
//        preferredTimescale : 표현 자릿수 92.1111111 -> 92.111 여기까지 1111
        let time = CMTime(seconds: secondes, preferredTimescale: 100)
